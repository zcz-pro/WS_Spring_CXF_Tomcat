...
public interface WebLisService {
     ...
     */
    @WebMethod(operationName="ESBWebInterface")
    String getPatOrdList(String code,String reqXmlContent);
     ...
     */
    @WebMethod(operationName="LISRequestQuery")
    String lISRequestQuery(String urid ,String pwd,String name,String args);
     ...
     * @date 2020/4/28 17:49
     */
    @WebMethod(operationName="LISReportSend")
    String lISReportSend(String urid ,String pwd,String name,String args);
    /**
     * @description 杭创社康
     * @author ZCZ
     * @version 1.0
    ...
    String invoke(String urid ,String pwd,String name,String args);
}
